...
O Software GBI não requer instalação, apenas que os requisitos de sistema sejam cumpridos. O usuário deve somente fazer o download do arquivo compactado e descompacta-lo preferencialmente no diretório C:.

---
## Licença:

GBI é um software gratuito.
